    ...
    <main>
        ...
        <div class="hero min-h-screen">
            <div class="hero-content flex-col lg:flex-row px-5 sm:px-16 2xl:px-0">
                <div class="flex justify-center">
                    <img src="./img/pengurus/eksternal/eksternal.jpg" alt="divisi eksternal" class="max-w-xs rounded-lg shadow-2xl" loading="lazy"/>
                </div>
        ...
        <div class="flex flex-wrap justify-evenly pb-6">
            <div class="inline-block m-2 card lg:w-72 max-w-xs bg-base-100 shadow-xl text-center sm:hover:-translate-y-2 duration-100">
                <figure><img src="./img/pengurus/eksternal/IMG_8004.jpg" alt="kadiv eksternal" class="max-h-min"></figure>
                <div class="card-body">
            ...
            <div class="inline-block m-2 card lg:w-72 max-w-xs bg-base-100 shadow-xl text-center sm:hover:-translate-y-2 duration-100">
                <figure><img src="./img/pengurus/eksternal/IMG_7997.jpg" alt="sekbend eksternal" class="max-h-min"></figure>
                <div class="card-body">
