    ...
    <main>
        ...
        <div class="flex flex-wrap justify-evenly pb-6">
            <div class="inline-block m-2 card lg:w-72 max-w-xs bg-base-100 shadow-xl text-center sm:hover:-translate-y-2 duration-100">
                <figure><img src="./img/pengurus/psi/kadiv-psi.jpg" alt="kadiv psi" class="max-h-min" loading="lazy"></figure>
                <div class="card-body">
            ...
            <div class="inline-block m-2 card lg:w-72 max-w-xs bg-base-100 shadow-xl text-center sm:hover:-translate-y-2 duration-100">
                <figure><img src="./img/pengurus/psi/sekbend-psi.jpg" alt="sekbend psi" class="max-h-min" loading="lazy"></figure>
                <div class="card-body">
