        ...
        <main>
          ...
          <div class="px-6 py-32 text-center sm:hidden">
            <div class="flex justify-center mb-4">
              <img src="{{asset('img/logo-unand.png')}}" alt="logo-unand" class="h-16 mx-2">
              <img src="{{asset('img/logo-hmsi.png')}}" alt="logo-hmsi" class="h-16 mx-2">
            </div>
          ...
          <div class="hero min-h-screen">
              <div class="hero-content flex-col lg:flex-row">
                <img src="./img/logo-hmsi.png" class="max-w-full sm:max-w-xl" />
          ...
          <div class="text-center">
            ...
            <a href="/div-psdm">
              <div class="inline-block m-2 card max-w-xs min-w-min bg-base-100 sm:hover:scale-105 duration-100 shadow-xl">
                <figure><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="fill-current h-28 pt-4"><path d="M45.63 79.75L52 81.25v58.5C45 143.9 40 151.3 40 160c0 8.375 4.625 15.38 11.12 19.75L35.5 242C33.75 248.9 37.63 256 43.13 256h41.75c5.5 0 9.375-7.125 7.625-13.1L76.88 179.8C83.38 175.4 88 168.4 88 160c0-8.75-5-16.12-12-20.25V87.13L128 99.63l.001 60.37c0 70.75 57.25 128 128 128s127.1-57.25 127.1-128L384 99.62l82.25-19.87c18.25-4.375 18.25-27 0-31.5l-190.4-46c-13-3-26.62-3-39.63 0l-190.6 46C27.5 52.63 27.5 75.38 45.63 79.75zM359.2 312.8l-103.2 103.2l-103.2-103.2c-69.93 22.3-120.8 87.2-120.8 164.5C32 496.5 47.53 512 66.67 512h378.7C464.5 512 480 496.5 480 477.3C480 400 429.1 335.1 359.2 312.8z"/></svg></figure>
                <div class="card-body">
                  <h2 class="card-title justify-center">Pengembangan Sumber daya Manusia</h2>
                  <p>Divisi yang bertanggung jawab dalam menghimpun anggota HMSI dalam mengoptimalkan dan memberdayakan seluruh potensi yang dimiliki, serta meningkatkan peran aktif mahasiswa melalui berbagai kegiatan.</p>
                </div>
              </div> 
            </a>
            <a href="/div-humas">
              <div class="inline-block m-2 card max-w-xs min-w-min bg-base-100 sm:hover:scale-105 duration-100 shadow-xl">
                ...
                <div class="card-body">
                  <h2 class="card-title justify-center">Hubungan Masyarakat</h2>
            ...
            <a href="/div-kwu">
              <div class="inline-block m-2 card max-w-xs min-w-min bg-base-100 sm:hover:scale-105 duration-100 shadow-xl">
                ...
                <div class="card-body">
                  <h2 class="card-title justify-center">Kewirausahaan</h2>
                  <p>Divisi yang berperan untuk membantu pencarian sumber dana HMSI dalam bentuk kegiatan kewirausahaan,yang tidak hanya berfokus pada keuntungan tetapi juga turut serta dalam proses pengembangan kreativitas berwirausaha mahasiswa.</p>
                </div>
              </div> 
            </a>
            ...
            <a href="/div-psi">
              <div class="inline-block m-2 card max-w-xs min-w-min bg-base-100 sm:hover:scale-105 duration-100 shadow-xl">
                ...
                <div class="card-body">
                  ...
                  <p>Divisi yang mewadahi mahasiswa dalam mengembangkan skill dan cara berpikir sebagai seorang mahasiswa IT, dan berperan sebagai media mahasiswa untuk lebih mengenal perkembangan IT serta prospek kerja saat ini</p>
                </div>
              </div> 
            </a>
            <a href="/div-rtk">
            ...
            <a href="/div-infomed">
              <div class="inline-block m-2 card max-w-xs min-w-min bg-base-100 sm:hover:scale-105 duration-100 shadow-xl">
                ...
                <div class="card-body">
                  <h2 class="card-title justify-center">Informasi dan Media</h2>
                  <p>Bertanggung-jawab dalam mengelola informasi, komunikasi, serta publikasi media antara Himpunan Mahasiswa Sistem Informasi dengan seluruh civitas akademika FTI Unand dan lembaga formal kampus dengan memanfaatkan berbagai media.</p>
                </div>
              </div> 
            </a>
          ...
          <section class="pesan text-center px-10">
            <h1 class="text-neutral-content text-3xl sm:text-5xl font-bold mb-2">Kotak Pesan</h1>
            <form action="" method="post">
              <input type="text" placeholder="Ketik nama anda" required class="input input-bordered w-full max-w-4xl my-3" /><br>
              <textarea class="textarea textarea-bordered my-3 w-full max-w-4xl" required placeholder="Ketik pesan anda"></textarea><br>
